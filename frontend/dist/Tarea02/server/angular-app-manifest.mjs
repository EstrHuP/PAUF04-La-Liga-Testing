...
export default {
  ...
  assets: {
    ...
    'index_admin/index.html': {size: 26719, hash: '1d3cbbe3a8e6ad1e187235780796819e00231d18f010400cec965119a807aa8a', text: () => import('./assets-chunks/index_admin_index_html.mjs').then(m => m.default)},
